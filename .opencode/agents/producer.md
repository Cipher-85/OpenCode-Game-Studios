...
**Agent memory** (originally `user`): OpenCode has no native agent-memory mechanism. Notes are preserved in `.opencode/agent-memory/` and should be consulted/maintained manually.
