...
**Isolation (worktree)**: This agent originally ran in an isolated git worktree. OpenCode has no native equivalent. Before making changes, ask the user whether to proceed in the current workspace or set up a branch manually.
